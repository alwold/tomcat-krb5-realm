...
To compile, run ant dist, and you will get a krb5-tomcat.jar file.  Put it in /usr/local/tomcat/common/lib.
Set up the realm according to http://jakarta.apache.org/tomcat/tomcat-5.0-doc/realm-howto.html#JAASRealm.
